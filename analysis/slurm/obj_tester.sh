...
FILE_PATH="/home/mescalin/miksch/Documents/data/cocopaths/paper_cocopath/sim_results_len6.tsv"
OUTPUT_FILE="/home/mescalin/miksch/Documents/data/cocopaths/slurm/output_variable/6_steps_out.txt"
CONDA_ENV="bioinf"
...
while true; do
    ...
    python slurm_obj_tester.py --file_path $FILE_PATH --index $NEXT_INDEX --output_file $OUTPUT_FILE
